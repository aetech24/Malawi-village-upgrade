  ...
  return (
    <>
      <main className="bg-white-100 px-4 max-md:mt-16 py-8 md:py-16 md:px-10">
        <h1 className="text-4xl font-bold mb-6 text-center mx-auto md:text-center py-10">
          About Us
        </h1>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 md:gap-16">
            ...
            <div className="text-center md:text-left md:w-1/2 ">
              ...
              {/*<p className="text-gray-600 text-lg leading-relaxed">
                ...
                <h1 className="text-4xl font-bold mb-6 text-center mx-auto md:text-left mt-3">
                Vision
              </h1>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                To be the most trusted place, for you and
                your family to break bread.
              </p>
            </div>
