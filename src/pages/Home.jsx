      ...
      <div className="py-12 flex flex-col gap-6">
        <div className="flex flex-col gap-5 px-4 md:px-10">
          ...
          <div className="w-full flex flex-col justify-center items-center px-6 py-10">
            <div className="">
              <h2 className="text-4xl font-[500] py-8">Featured</h2>
            </div>
            <div className="w-full flex lg:flex-row flex-col justify-center items-center gap-8">
              <div className="flex flex-col lg:w-1/3 w-full h-full object-cover group hover:drop-shadow-2xl">
                <img
                  src={Feature1}
                  alt="Malawi Services"
                  className="w-full h-[200px] lg:h-[300px] md:h-[410px] object-cover group-hover:scale-105 duration-200"
                />
                <div className="flex flex-col items-center justify-center gap-2 py-6 lg:py-10">
                  ...
                  <p className="text-center">
                    We offer personalized services to meet your needs
                  </p>
                </div>
                <div className="flex justify-center items-center underline hover:text-yellow duration-200 text-xl lg:text-2xl py-6 lg:py-10">
                  <Link to="/products">Discover The Categories</Link>
                </div>
              </div>
              <div className="flex flex-col lg:w-1/3 w-full h-full object-cover group hover:drop-shadow-2xl">
                <img
                ...
                <div className="flex justify-center items-center underline hover:text-yellow duration-200 text-xl lg:text-2xl py-6 lg:py-10">
                  <Link to="/products">Order From Store</Link>
                </div>
              </div>
              <div className="flex flex-col lg:w-1/3 w-full h-full object-cover group hover:drop-shadow-2xl">
                <img
                ...
                <div className="flex justify-center items-center underline hover:text-yellow duration-200 text-xl lg:text-2xl py-6 lg:py-10">
                  <Link to="/products">Discover How</Link>
                </div>
              </div>
            </div>
          </div>
